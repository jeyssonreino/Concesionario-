...
if (isset($_POST['ejecutar'])) {
    ...
    /* PROCEDIMIENTO ALMACENADO PARA VER LA INFORMACIÓN DE UN PROVEEDOR SEGUN SU NOMBRE
    EJEMPLO: 1
    */
    $sql = "CALL telefono_proveedor('$valor');";
...
<header>
    ...
    <br><h1>INFORMACION DEL PROVEEDOR</h1>
</header>
<body>
    ...
    <div>
        <div>
            <form action="procedures8.php" method="POST" class="formulario">
                <div >
                    <label for="Digite el nombre del proveedor para ver su informacion"></label>
                </div>
                <div class="buscar">

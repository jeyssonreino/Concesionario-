...
$conexion = mysqli_connect($server, $user, $pass, $db);
    /* PROCEDIMIENTO ALMACENADO PARA CALCULAR EL PRECIO MAS BAJO DE TODOS LOS AUTOS
    */ 
    
    $sql = " SELECT calcular_precio_mas_bajo();";
...
<header>
    ...
    <br><h1>PRECIO MAS BAJO DE TODOS LOS CARROS  </h1>
</header>
<body>

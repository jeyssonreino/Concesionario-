...
if (isset($_POST['ejecutar'])) {
    ...
    /* PROCEDIMIENTO ALMACENADO PARA VER LA CANTIDAD DE UN AUTO SEGUN SU NOMBRE 
    EJEMPLO "MUSTANG"
    */ 
    $sql = "CALL cantidad_de_autos_por_nombre('$valor')";
...
<header>
    ...
    <br><h1>INFORMACION DE UN AUTO </h1>
</header>
...
<body>
    ...
    <div>
        <div>
            <form action="procedures2.php" method="POST" class="formulario">
                <div >
                    <label for="Digite el nombre de un automovil para ver la cantidad"></label>
                </div>
                <div class="buscar">
                    <input type="text" name='valor' placeholder="Auto">
                </div>
                <div class="btnbuscar">

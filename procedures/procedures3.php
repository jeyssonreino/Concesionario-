...
if (isset($_POST['ejecutar'])) {
    ...
    /* PROCEDIMIENTO ALMACENADO PARA VER EL PRECIO DE UN AUTO SEGÚN SU NOMBRE 
    EJEMPLO "MUSTANG"
    */ 
    $sql = "CALL precio_de_auto_por_nombre('$valor')";
...
<body>
    ...
    <div>
        <div>
            <form action="procedures3.php" method="POST" class="formulario">
                <div >

...
$conexion = mysqli_connect($server, $user, $pass, $db);
    /* PROCEDIMIENTO ALMACENADO PARA CALCULAR EL PRECIO MEDIO DE TODOS LOS AUTOS
    */ 
    
    $sql = " SELECT calcular_precio_medio_total();";
...
<header>
    ...
    <br><h1>PRECIO MEDIO DE TODOS LOS CARROS </h1>
</header>
<body>

...
$conexion = mysqli_connect($server, $user, $pass, $db);
    /* PROCEDIMIENTO ALMACENADO PARA CALCULAR EL PRECIO MAS ALTO DE TODOS LOS AUTOS
    */ 
    
    $sql = " SELECT calcular_precio_mas_alto();";
...
<header>
    ...
    <br><h1>PRECIO MAS ALTO DE TODOS LOS CARROS </h1>
</header>
<body>

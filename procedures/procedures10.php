...
if (isset($_POST['ejecutar'])) {
    ...
    /* PROCEDIMIENTO ALMACENADO PARA VER EL PRECIO MEDIO SEGUN EL PROVEEDOR
    EJEMPLO: 1
    */
    $sql = "SELECT calcular_precio_medio_por_proveedor('$valor');";
...
<header>
    ...
    <br><h1>PRECIO MEDIO DE AUTO SEGUN PROVEEDOR</h1>
</header>
<body>
    <div>
        <div>
            <form action="procedures10.php" method="POST" class="formulario">
                <div>
                    <label for="Digite el nombre del proveedor para ver el precio medio"></label>
                </div>
                <div class="buscar">

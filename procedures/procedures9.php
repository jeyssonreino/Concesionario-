...
if (isset($_POST['ejecutar'])) {
    ...
    /* PROCEDIMIENTO ALMACENADO PARA VER EL PRECIO MINIMO SEGUN EL PROVEEDOR
    EJEMPLO: 1
    */
    $sql = "SELECT calcular_precio_minimo_por_proveedor('$valor');";
...
<header>
    ...
    <br><h1>PRECIO MINIMO DE AUTO SEGUN PROVEEDOR</h1>
</header>
<body>
    ...
    <div>
        <div>
            <form action="procedures9.php" method="POST" class="formulario">
                <div>
                    <label for="Digite el nombre del proveedor para ver el precio minimo"></label>
                </div>
                <div class="buscar">
